...
import com.infodart.instaproject.fragments.UsersFragment.OnListFragmentInteractionListener;
...
public class UsersRecyclerViewAdapter extends RecyclerView.Adapter<UsersRecyclerViewAdapter.ViewHolder> {
    ...
    public UsersRecyclerViewAdapter(List<Users> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
